...
public class HologramManager {
    ...
    public void createVendorHologram(Vendor vendor) {
        ...
        List<String> lines = getHologramLines(vendor);
    ...
    private List<String> getHologramLines(Vendor vendor) {
        ...
        if (vendor.getItemCount() > limit) {
            lines.add("&7... +&f" + (vendor.getItemCount() - limit) + " &7items");
        }
